<div class="flex items-center gap-4 text-[16px] font-medium text-gray-900 focus:outline-none bg-white rounded-[10px] border border-gray-200 overflow-hidden relative">
    <button class="flex items-center py-2.5 px-5 hover:text-blue-700 hover:bg-gray-100 transition-colors h-full" wire:click="decrement" wire:loading.attr="disabled">
