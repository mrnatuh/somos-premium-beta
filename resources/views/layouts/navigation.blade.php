<nav x-data="{ open: false }" class="bg-gray-100 border-r border-gray-100 dark:border-gray-700 max-w-[250px] h-screen">
    <div class="flex gap-4 p-3 items-center">
        ...
        <button class="border flex items-center justify-center w-[50px] h-10 rounded-md hover:bg-slate-100 hover:opacity-95">
