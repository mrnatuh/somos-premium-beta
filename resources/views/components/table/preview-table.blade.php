    ...
    <table class="w-full caption-bottom text-sm">
        ...
        <tbody class="[&amp;_tr:last-child]:border-0">
            ...
            <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                ...
                @if(!Auth::user()->cc)
                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0">{{ $preview->cc }}</td>
                @endif
                ...
                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0 text-center ">
                    <span class="{{ $preview->status }}">{{ $preview_status[$preview->status] ?? '-' }}</span>
                </td>
                <td class="px-4 text-center align-middle [&amp;:has([role=checkbox])]:pr-0">{{ $preview->variation ?? '0%' }}</td>
                <td class="px-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
